...
--
-- Name: liveclinicdb; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE liveclinicdb WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'English_United States.1252';


ALTER DATABASE liveclinicdb OWNER TO postgres;

\connect liveclinicdb
...
--
-- Name: updatebilling(character varying, character varying, character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.updatebilling(p_order_id character varying, p_newstatus character varying, p_payment_method character varying DEFAULT 'online payment'::character varying) RETURNS character varying[]
    LANGUAGE plpgsql
    AS $$
DECLARE 
...
ALTER FUNCTION public.updatebilling(p_order_id character varying, p_newstatus character varying, p_payment_method character varying) OWNER TO postgres;
